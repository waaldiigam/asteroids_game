...
from constants import ASTEROID_MIN_RADIUS, ASTEROID_NEW_SPEED, PARTICLE_LIFETIME
...
class Asteroid(CircleShape):
    ...
    def split(self):
        for _ in range(15):
            ExplosionParticle(self.position.x, self.position.y, random.uniform(0, 360), PARTICLE_LIFETIME)
        self.kill()
